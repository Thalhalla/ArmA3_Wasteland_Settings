...
A3W_atmMaxBalance = 16777215;       // Maximum amount of money that can be stored in a bank account (don't go over 16777216 as numbers start losing accuracy)
...
A3W_vehicleQuantity = 333;         // Approximate number of land vehicles to be spawned in towns
...
A3W_buildingLootChances = 33;      // Chance percentage that loot will spawn at each spot in a building (0 to 100)
...
A3W_payrollAmount = 1080;           // Amount of money rewarded per territory on each payroll
